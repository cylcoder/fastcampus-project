...
public class FakeObjectFactory {
    ...
    private static final UserRelationService userRelationalService = new UserRelationService(userService, fakeUserRelationRepository);
    ...
    public static UserRelationService getUserRelationalService() {
        return userRelationalService;
    }
